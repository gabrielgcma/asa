...
def pdf_process_function(msg):
    ...
    pdf.cell(200, 10, txt="ID --------> {0}".format(json_data["id"]), ln=1, align="C")
    pdf.cell(200, 20, txt="Nome ------> {0}".format(json_data["nome"]), ln=2, align="C")
    pdf.cell(
...
def main():
    ...
    channel.basic_consume(
        queue="pdfprocess", on_message_callback=callback, auto_ack=True
    )
